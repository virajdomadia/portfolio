...
export const content: Content = ContentSchema.parse({
  ...
  projects: [
    { slug: 'smart-job-board', code: 'SJB', title: 'Smart Job Board', category: 'full-stack', blurb: 'Role-based auth for seekers and employers, résumé uploads to Cloudinary, personal dashboards and AI job–résumé matching.', stack: ['React', 'Node', 'Express', 'MongoDB', 'JWT'], live: 'https://example.com/job-board', repo: `${GH}/smart-job-board`, image: '/images/projects/smart-job-board.jpg' },
    { slug: 'real-time-chat', code: 'RTC', title: 'Real-Time Chat', category: 'real-time', blurb: 'One-to-one messaging over WebSockets with a JWT handshake, reconnect on token refresh and a REST API for history.', stack: ['Socket.io', 'Express', 'MongoDB'], live: 'https://example.com/chat', repo: `${GH}/real-time-chat`, image: '/images/projects/real-time-chat.jpg' },
    { slug: 'e-commerce', code: 'SHOP', title: 'E-Commerce', category: 'full-stack', blurb: 'Storefront with admin-only product CRUD, cart and checkout, JWT sessions with bcrypt.', stack: ['React', 'Express', 'MongoDB', 'bcrypt'], live: 'https://example.com/store', repo: `${GH}/e-commerce`, image: '/images/projects/e-commerce.jpg' },
    { slug: 'expense-tracker', code: 'EXP', title: 'Expense Tracker', category: 'full-stack', blurb: 'Categorised expenses with CRUD, filtering and a summary dashboard.', stack: ['React', 'Express', 'MongoDB', 'Tailwind'], live: 'https://example.com/expenses', repo: `${GH}/expense-tracker`, image: '/images/projects/expense-tracker.jpg' },
    { slug: 'ecommerce-ui', code: 'UI', title: 'Ecommerce UI', category: 'frontend', blurb: 'Frontend-only store: listings, details and cart — built to drop onto any API.', stack: ['React', 'Tailwind', 'JavaScript'], live: 'https://example.com/store-ui', repo: `${GH}/ecommerce-ui`, image: '/images/projects/ecommerce-ui.jpg' },
  ],
