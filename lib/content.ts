...
export const content: Content = {
  ...
  projects: [
    { slug: 'tripsmith', title: 'Tripsmith', category: 'Travel + AI concierge', status: 'In build · landing page live',
      blurb: 'A travel-agency site where a chatbot plans a real itinerary from live packages and starts the booking — tool-calling agent, Razorpay checkout, admin for packages and bookings.',
      stack: ['Next.js', 'TypeScript', 'FastAPI', 'PostgreSQL', 'Vercel AI SDK', 'Razorpay'],
    ...
    { slug: 'frontrow', title: 'Frontrow', category: 'Live seat-map ticketing', status: 'In build · landing page live',
      ...
      live: 'https://frontrow-viraj.vercel.app', repo: 'https://github.com/virajdomadia/frontrow', image: '/images/projects/frontrow.jpg' },
    { slug: 'pagecraft', title: 'Pagecraft', category: 'Co-edited website builder', status: 'In build · landing page live',
      blurb: 'A landing-page editor two people use at the same time — live cursors, conflict-free merges, version history — then one click publishes it to its own subdomain.',
      stack: ['Next.js', 'TypeScript', 'Yjs', 'WebSockets', 'FastAPI', 'PostgreSQL'],
      live: 'https://pagecraft-viraj.vercel.app', repo: 'https://github.com/virajdomadia/pagecraft', image: '/images/projects/pagecraft.jpg' },
    { slug: 'offcut', title: 'Offcut', category: 'D2C store + visual search', status: 'In build · landing page live',
      blurb: 'A complete streetwear store — variants, inventory that cannot go negative, cart, orders, returns, admin — plus “drop a photo, shop the look” search on image embeddings.',
      stack: ['Next.js', 'TypeScript', 'FastAPI', 'PostgreSQL', 'pgvector', 'Cloudinary', 'Razorpay'],
      live: 'https://offcut-viraj.vercel.app', repo: 'https://github.com/virajdomadia/offcut', image: '/images/projects/offcut.jpg' },
    { slug: 'skillroom', title: 'Skillroom', category: 'Video course platform', status: 'In build · landing page live',
      blurb: 'Creators upload video courses; students buy or subscribe, resume where they left off, pass quizzes and earn a certificate — streaming, recurring billing, payouts, three-role access.',
      stack: ['Next.js', 'TypeScript', 'FastAPI', 'PostgreSQL', 'Mux', 'Razorpay Subscriptions'],
      live: 'https://skillroom-viraj.vercel.app', repo: 'https://github.com/virajdomadia/skillroom', image: '/images/projects/skillroom.jpg' },
    { slug: 'platter', title: 'Platter', category: 'Food delivery + live tracking', status: 'In build · landing page live',
      blurb: 'Customer, restaurant and rider apps on one order state machine — restaurants within a radius, live rider location on the customer’s map, role-checked transitions.',
      stack: ['Next.js', 'TypeScript', 'FastAPI', 'PostGIS', 'WebSockets', 'MapLibre'],
      live: 'https://platter-viraj.vercel.app', repo: 'https://github.com/virajdomadia/platter', image: '/images/projects/platter.jpg' },
  ],
  projectsNote: { after: 'Each one ships with a public repo, a live URL and a case study as it gets built. The landing pages are live now; the products follow.', afterCta: 'All repos on GitHub' },
  tools: [
  ...
  band: { headline: 'Build. Ship. Repeat.', sub: 'Code first, slides never — what I build at work is live at zapigo.com, and six more products are on the way above.', alt: 'Illustration of a developer coding at night with a laptop and two monitors' },
  contact: {
